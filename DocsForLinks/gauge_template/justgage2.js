...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "green"),

    // shadowOpacity : int
    // 0 ~ 1
    shadowOpacity: kvLookup('shadowOpacity', config, dataset, 0.9),

    // shadowSize: int
    // inner shadow size
    shadowSize: kvLookup('shadowSize', config, dataset, 20),
    ...
    labelMinFontSize: kvLookup('labelMinFontSize', config, dataset, 20),
  ...
  if (obj.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH /  5.5) > obj.config.valueMinFontSize) ? (widgetH /  5.5) : obj.config.valueMinFontSize;
    valueX = dx + widgetW / 2;
